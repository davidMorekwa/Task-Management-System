    ...
    <AuthenticatedLayout>
        ...
        <template #main-content>
            <div class="w-full h-full">
                <h1 class="text-3xl font-bold text-center">Pending Tasks</h1>
                <p v-if="props.message != ''">{{ props.message }}</p>
                <br />
                <table
                    v-if="props.pendingTasks.length > 0"
                    class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400"
                >
                    <thead
                        class="text-xs text-gray-700 uppercase bg-gray-300 w-full"
                    >
                        <tr>
                    ...
                    <tbody>
                        <tr
                            ...
                            v-for="task in props.pendingTasks"
                        >
                            <th
                                scope="row"
