...
import NavLink from "@/Pages/Components/NavLink.vue";
import ResponsiveNavLink from "@/Pages/Components/ResponsiveNavLink.vue";
    ...
    <div>
        <div class="min-h-screen bg-gray-100">
            ...
            <div class="flex flex-row justify-around border">
                ...
                <!-- Page Content -->
                <main class="w-[70vw] border bg-gray-50">
